<template>
  <main class="container" style="max-width:560px; padding:24px; display:grid; gap:14px">
    ...
    <form class="card" style="padding:16px; display:grid; gap:10px" @submit.prevent="emailSignIn">
...
import { useSupabaseClient } from '@supabase/auth-helpers-shared'
// Fallback for Nuxt module composable name
const supabase = (globalThis as any).useSupabaseClient ? (globalThis as any).useSupabaseClient() : (useSupabaseClient as any)()
